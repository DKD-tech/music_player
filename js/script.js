...
function nextMusic(){
    ...
    //if musicIndex is greater than array length musicIndex will be 1 so the first music play
...
function prevMusic(){
    musicIndex--; // increment of musicIndex by 1
    //if musicIndex is less than array length musicIndex will be 1 so the first music play
...
// upddate progress bar width according to music current time
...
//above we just change icon, now llet's work on what to do after song ended 
    ...
    switch (getText){
        case "repeat":
           ...
           case "repeat_one":
            ...
            loadMusic(musicIndex); //calling load music function width argument, in the argument there is a index of current song
            ...
            case "shuffle":
             ...
             musicIndex = randIndex; // passing randomIndeex to musicIndex
             loadMusic(musicIndex);
             playMusic();
             playingSong();
            break;
...
liAudioTag.addEventListener("loadeddata", () =>{
    ...
    //adiing t-duration attribute with total duration value
